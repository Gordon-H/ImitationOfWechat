...
import com.example.lbf.imitationofwechat.beans.ImageSize;
...
import com.example.lbf.imitationofwechat.util.MImageLoader;
import com.example.lbf.imitationofwechat.views.CommentsTextView;
import com.example.lbf.imitationofwechat.views.ExpandTextView;
import com.example.lbf.imitationofwechat.views.MultiItemTextView;
 ...
 */
public class MomentsListAdapter extends BaseAdapter<MomentBean> {
    ...
    public MomentsListAdapter(Context context, List<MomentBean> beanList) {
        ...
        imageLoader = MImageLoader.getInstance();
    ...
    @Override
    protected void convert(final BaseViewHolder holder, final MomentBean bean) {
        int type = holder.getItemViewType();
        if (type == TYPE_ITEM_HEAD) {
            return;
        }
        String contactName = bean.getContact().getName();
        String contactImage = bean.getContact().getImage();
        ...
        holder.setText(R.id.tv_time, CommonUtil.formatTime(bean.getTime()));
        holder.setImage(R.id.iv_profile_photo, contactImage);
...
//            });
    ...
    private void showOrHidePopupWindow(View v, final BaseViewHolder holder) {
        if(popupWindow == null){
    ...
    private void convertImages(BaseViewHolder holder, String[] images) {
        TextView textView;
    }

    private void convertLink(final BaseViewHolder holder, String link) {
