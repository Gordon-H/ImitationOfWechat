 ...
 */
public class ImageGridAdapter2 extends BaseAdapter<String> {
...
//    拍摄新照片
    ...
    public ImageGridAdapter2(Context context, List<String> beanList, int selectMode) {
        ...
        loader = MImageLoader.getInstance();
    ...
    @Override
    protected void convert(final BaseViewHolder holder, String bean) {
