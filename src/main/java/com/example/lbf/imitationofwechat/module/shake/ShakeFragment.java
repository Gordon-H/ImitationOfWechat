package com.example.lbf.imitationofwechat.module.shake;
...
import com.example.lbf.imitationofwechat.module.shakeSetting.ShakeSettingActivity;
    ...
    private void initView() {
        ...
        ivHidden.post(new Runnable() {
            ...
            public void run() {
                ...
                ivUp.setTranslationY(-(imageHeight/2.0f));
                ivDown.setTranslationY(imageHeight/2.0f);
