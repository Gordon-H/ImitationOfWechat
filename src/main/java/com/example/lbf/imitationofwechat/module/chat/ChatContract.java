...
//        添加消息
        void addMessage(BmobIMMessage messageBean);
//        发送消息
...
//        设置消息列表
        void setMessagesList(List<BmobIMMessage> beanList);
//        设置图片列表
        void setImageList(List<String> beanList);
//        更新消息列表
        void updateMessagesList();
//        更新图片列表
        void updateImageList();
//        长按chat item后展开菜单进行编辑
        void showEditMenu(android.view.View v, BmobIMMessage messageBean);
//        双击消息后全屏展示
...
//        隐藏语音输入布局
        ...
        void setVoiceBtListener(android.view.View.OnTouchListener listener);

        void setVoiceBtClickable(boolean isClickable);
//        设语音输入布局的状态
        void setVoiceLayoutState(boolean isNormal);
//        显示时间太短的提示
        void showHintTooShort();
//        显示发送按钮
        void showSendButton();
//        隐藏发送按钮
        void hideSendButton();
